...
> Since April 2025, the update to Symfony 7.2 has been done, please see the changes here: [Custom Easy Admin - update to Symfony 7.2](/blog/2025/custom-easy-admin-update-to-symfony-7-2)
...
<BlogImage src="2022/symfony-easyadmin-space-for-extra-functionalities/hoop.jpg" alt="What's the target here?" />

<p style={{textAlign: "center", marginTop: "-25px", color: "#777"}}>What's the target here?</p>
